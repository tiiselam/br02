...
namespace MaquinaDeEstados
{
    public class ReglasME_old
    {
        ...
        public ReglasME_old( bool emite, bool imprime, bool publica, bool envia)
        {
            _emite = emite;
            _imprime = imprime;
            _publica = publica;
        ...
        public bool ValidaTransicion(string tipoDoc, string accion, string eBinarioActual)
        {
            ...
            {
                    if (_emite && _imprime && eBinarioActual.Equals("000000"))
                    {
            ...
            {
                    if (_emite && eBinarioActual.Equals("000000"))
                    {
            ...
            {
                    if (_emite == Utiles.Derecha(eBinarioActual, 1).Equals("1"))//emitido
                    {
                        if (_imprime)
            ...
            {
                if (_emite == emitido(eBinarioActual) && !SunatRechazaComprobanteOAceptaBaja(eBinarioActual) && !SunatRechazaBaja(eBinarioActual) && !BajaSolicitada(eBinarioActual))
                {
            ...
            {
                if (_emite == emitido(eBinarioActual) && !SunatRechazaComprobanteOAceptaBaja(eBinarioActual) && !BajaSolicitada(eBinarioActual) && !SunatAceptaComprobante(eBinarioActual) && !SunatRechazaBaja(eBinarioActual) )
                {
                ...
                else if (_emite == emitido(eBinarioActual) && !SunatRechazaComprobanteOAceptaBaja(eBinarioActual) && BajaSolicitada(eBinarioActual) && SunatAceptaComprobante(eBinarioActual) && !SunatRechazaBaja(eBinarioActual))
                {
            ...
            {
                //if (_emite == emitido(eBinarioActual) && !Anulado(eBinarioActual) && !RechazaSunat(eBinarioActual) && publicado(eBinarioActual))
                //{
            ...
            //            && _imprime == Utiles.Derecha(eBinarioActual, 3)[0].Equals('1')  //impreso
            //                                                                                      //&& _publica == Utiles.Derecha(eBinarioActual, 4)[0].Equals('1')  
            ...
            //{
            //        if (_emite && _publica && !RechazaSunat(eBinarioActual) && !publicado(eBinarioActual) && !AceptaSunat(eBinarioActual))
            //        {
            ...
            //{
            //    //if (_emite && _publica && publicado(eBinarioActual) && !RechazaSunat(eBinarioActual) && !AceptaSunat(eBinarioActual))
            //    //{
        ...
        public bool ValidaTransicion(string tipoDoc, string accion, string eBinarioActual, string eBaseNuevo)
        {
            ...
            if (tipoDoc.Equals("FACTURA") && accion.Equals("CONSULTA CDR"))
            {
                if (eBaseNuevo.Equals("consulta a la sunat"))
                    if (_emite == emitido(eBinarioActual) && !SunatRechazaComprobanteOAceptaBaja(eBinarioActual) && BajaSolicitada(eBinarioActual) && !SunatRechazaBaja(eBinarioActual))
                    {
                        _eBinarioNuevo = Utiles.Izquierda(eBinarioActual, 4) + "1" + Utiles.Derecha(_eBinarioNuevo, 1);     //baja aceptada
                        _eBinarioNuevo = "0" + Utiles.Derecha(_eBinarioNuevo, 5);
                        eBinActualConError = Utiles.Izquierda(eBinarioActual, 4) + "0" + Utiles.Derecha(_eBinarioNuevo, 1); //baja rechazada
